    ...
    h(
      ...
      [
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'M21 12a2.25 2.25 0 00-2.25-2.25H15a3 3 0 110 6h3.75A2.25 2.25 0 0021 13.5v-1.5zm0 0V9.75A2.25 2.25 0 0018.75 7.5H5.25A2.25 2.25 0 003 9.75v4.5A2.25 2.25 0 005.25 16.5h13.5A2.25 2.25 0 0021 14.25V12zM5.25 7.5V6a2.25 2.25 0 012.25-2.25h9A2.25 2.25 0 0118.75 6v1.5'
        })
      ]
    )
}
...
const userNavItems = computed(() => {
  const items = [
    ...
    { path: '/models', label: t('nav.modelSquare'), icon: SparklesIcon },
    ...
    ...(appStore.cachedPublicSettings?.referral_enabled
      ...
      : []),
    { path: '/install-guide', label: t('nav.installGuide'), icon: BookOpenIcon },
...
const adminNavItems = computed(() => {
  ...
  if (authStore.isSimpleMode) {
    ...
    filtered.push({ path: '/admin/payment', label: t('nav.paymentSettings'), icon: WalletIcon })
    filtered.push({ path: '/admin/data-management', label: t('nav.dataManagement'), icon: DatabaseIcon })
    filtered.push({ path: '/admin/settings', label: t('nav.settings'), icon: CogIcon })
    filtered.push({ path: '/install-guide', label: t('nav.installGuide'), icon: BookOpenIcon })
    return filtered
  }

  baseItems.push({ path: '/admin/payment', label: t('nav.paymentSettings'), icon: WalletIcon })
