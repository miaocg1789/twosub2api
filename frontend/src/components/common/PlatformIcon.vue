<template>
  ...
  <!-- DeepSeek logo (CPU/chip) -->
  <svg v-else-if="platform === 'deepseek'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M18 3v2h-2V3H8v2H6V3H3v3h2v2H3v4h2v2H3v2h2v2H3v3h3v-2h2v2h8v-2h2v2h3v-3h-2v-2h2v-2h-2v-2h2V8h-2V6h2V3h-3zM8 15V9h8v6H8zm2-4v2h4v-2h-4z" />
  </svg>
  <!-- Qwen logo (cloud-cog) -->
  <svg v-else-if="platform === 'qwen'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM12 17l-1.56-.88.28-1.78-1.33-1.25 1.8-.22L12 11.2l.81 1.67 1.8.22-1.33 1.25.28 1.78L12 17z" />
  </svg>
  <!-- GLM logo (sparkles/brain) -->
  <svg v-else-if="platform === 'glm'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29a.996.996 0 0 0-1.41 0L1.29 18.96a.996.996 0 0 0 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05a.996.996 0 0 0 0-1.41l-2.33-2.35zM5.21 19.38L4.63 18.8 14.34 9.1l.58.58-9.71 9.7z" />
  </svg>
