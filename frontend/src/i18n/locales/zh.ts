export default {
  ...
  modelSquare: {
    title: '模型广场',
    subtitle: '浏览所有可用 AI 模型的定价与特性，实时同步上游数据',
    description: '浏览和选择AI模型',
    ...
    noModels: '没有找到匹配的模型',
    lastUpdated: '更新时间',
    priceUnit: '价格单位: USD / 1M tokens（点击模型名称可复制）',
    prev: '上一页',
    next: '下一页'
  },
  ...
  installGuide: {
    title: '安装文档',
    subtitle: '各种 AI 编程工具的安装与配置指南，支持 Windows / macOS / Linux',
    copyCommand: '复制命令',
    claudeCodeDesc: 'Anthropic 官方 CLI 编程助手',
    codexDesc: 'OpenAI 官方 CLI 编程助手',
    geminiCliDesc: 'Google Gemini 命令行工具',
    githubCopilotDesc: 'GitHub AI 编程助手 (VS Code 扩展)',
    cursorDesc: 'AI 驱动的代码编辑器',
    clineDesc: 'VS Code AI 编程助手扩展',
    openCodeDesc: '开源 AI 编程 CLI 工具 (Go)',
    openClawDesc: '开源 AI 编程 CLI 工具 (Python)',
    steps: {
      installNodejs: '安装 Node.js (LTS)',
      installNodejsNote: '如果已安装 Node.js >= 18，可跳过此步骤',
      installClaudeCode: '安装 Claude Code',
      installTool: '安装 {name}',
      configureEnv: '配置环境变量',
      run: '启动运行',
      claudeCodeNote: '首次运行会引导你完成 API 密钥配置，将 Base URL 和 API Key 替换为你的实际值',
      codexNote: '将 Base URL 和 API Key 替换为你的实际值即可使用',
      geminiCliNote: "也可通过 npx {'@'}anthropic-ai/gemini-cli 直接运行，无需全局安装",
      installVscode: '安装 VS Code',
      vscodeNote: '如果已安装 VS Code，可跳过此步骤',
      vscodeAlternative: '也可从 https://code.visualstudio.com 下载 .deb 包手动安装',
      installExtension: '安装 {name} 扩展',
      configureGithubCopilot: '配置 GitHub Copilot',
      githubCopilotNote: '打开 VS Code → 点击左下角齿轮图标 → Settings → 搜索 "github.copilot" → 登录你的 GitHub 账号并授权 Copilot',
      downloadCursor: '下载安装 Cursor',
      cursorDownloadNote: '也可从 https://cursor.com 官网下载安装包',
      cursorLinuxNote: '从 https://cursor.com 下载 Linux 版本 (.AppImage)',
      installCursorLinux: '运行安装',
      configureCursor: '打开 Cursor 并登录',
      cursorConfigNote: '打开 Cursor → Settings → Models → 配置你的 API 信息',
      configureCursorModel: '配置自定义 API 端点',
      cursorModelNote: '在 Cursor Settings → Models 中填入你的 API Base URL 和 API Key',
      configureCline: '配置 Cline 扩展',
      clineConfigNote: '打开 VS Code → 侧边栏点击 Cline 图标 → 在设置中填入 API Provider 选择 "OpenAI Compatible"，输入你的 Base URL 和 API Key',
      installGo: '安装 Go 语言环境',
      goNote: '如果已安装 Go >= 1.21，可跳过此步骤',
      installPython: '安装 Python',
      pythonNote: '如果已安装 Python >= 3.10，可跳过此步骤',
    }
  },
  ...
  wallet: {
    ...
    customAmount: '自定义金额',
    enterAmount: '请输入充值金额',
    amountRange: '金额范围: {currency}{min} - {currency}{max}',
    creditPreview: '充值后获得 ${credit} 额度',
    paymentMethod: '支付方式',
    methodAlipay: '支付宝',
    methodAlipayF2f: '支付宝当面付',
    methodWechat: '微信支付',
    methodEpay: '易支付',
    methodEpayAlipay: '支付宝',
    methodEpayWechat: '微信支付',
    payNow: '立即支付',
    creating: '创建订单中...',
    ...
    alreadyPaid: '我已完成支付',
    checking: '查询中...',
    notPaidYet: '暂未查询到支付结果，请稍后再试',
    checkFailed: '查询支付状态失败',
    paymentSuccessTitle: '支付成功！',
    paymentSuccessMessage: '余额已到账，感谢您的充值。',
    paymentExpired: '订单已过期或支付失败',
    recentActivity: '最近记录',
    last30Days: '最近 30 天',
    topUpOrder: '充值',
    clickToShowOrderNo: '点击显示完整订单号',
    historyEmpty: '暂无交易记录',
    orderHistory: '充值订单',
    orderNo: '订单号',
    orderAmount: '金额',
  ...
  referral: {
    title: '推荐返利',
    description: '邀请好友注册，好友充值可获得返利',
    myReferralLink: '我的推荐链接',
    copyLink: '复制链接',
    linkCopied: '推荐链接已复制',
    stats: '推荐统计',
    totalInvitees: '邀请人数',
    totalCommission: '累计返利',
    people: '人',
    invitees: '邀请记录',
    commissions: '返利记录',
    inviteeEmail: '用户邮箱',
    ...
    commissionTime: '返利时间',
    noInvitees: '暂无邀请记录',
    noCommissions: '暂无返利记录',
    enabled: '启用推荐返利',
    enabledHint: '启用后用户可通过推荐链接邀请好友注册，好友充值时推荐人可获得返利',
    commissionRateLabel: '返利比例',
    commissionRateHint: '推荐人可获得被推荐人充值金额的百分比作为返利'
  },
  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        rateMultiplierHint: '0 = 免费，0.5 = 半价，1.0 = 标准费率，2.0 = 双倍',
        exclusiveLabel: '专属分组',
      ...
      perRequestPricing: {
        title: '按次计费',
        desc: '启用后，该分组下的所有请求将按每次固定价格计费，而非按 token 计算',
        price: '每次请求单价 (USD)',
        pricePlaceholder: '例如 0.01',
        priceHint: '该分组下的所有请求将按此固定价格计费',
        enabled: '已启用',
        disabled: '已禁用'
      }
    },
    ...
    accounts: {
      ...
      upstreamModelsFetched: '已从上游获取 {count} 个模型',
      upstreamModelsFetchError: '获取上游模型失败',
      ...
      dailyLimits: {
        title: '每日限额',
        hint: '限制账号每天的费用和请求次数，超限后自动暂停调度，次日零点自动恢复',
        cost: {
          label: '每日费用限额',
          placeholder: '50',
          hint: '达到限额后账号暂停调度至次日零点，0 或留空表示不限制'
        },
        requests: {
          label: '每日请求次数',
          placeholder: '100',
          hint: '达到次数后账号暂停调度至次日零点，0 或留空表示不限制'
        }
      },
      expired: '已过期',
      proxy: '代理',
      ...
      oauth: {
        ...
        kimi: {
          ...
          deviceFlowDesc: '使用设备授权码完成 Kimi 账号授权'
        },
        // iFlow specific
        iflow: {
          cookieAuth: 'Cookie 授权',
          cookieAuthDesc: '使用浏览器 Cookie 完成 iFlow 账号授权'
        }
      },
    ...
    settings: {
      ...
      payment: {
        title: '支付设置',
        description: '配置在线支付功能，支持支付宝、微信支付和易支付',
        enabled: '启用在线支付',
        enabledHint: '允许用户通过在线支付方式充值余额',
        generalTitle: '通用配置',
        currency: '货币',
        currencyHint: '支付使用的货币单位',
        exchangeRate: '兑换比率',
        exchangeRateHint: '1 单位支付货币兑换多少平台额度（例如 1 CNY = 0.14 USD）',
        presetAmounts: '预设金额',
        presetAmountsHint: '用逗号分隔，例如：10,20,50,100',
        minAmount: '最小金额',
        minAmountHint: '单笔充值最小金额',
        maxAmount: '最大金额',
        maxAmountHint: '单笔充值最大金额',
        alipayTitle: '支付宝配置',
        alipayEnabled: '启用支付宝',
        alipayMode: '支付宝模式',
        alipayModeDisabled: '关闭',
        alipayModeRegular: '常规支付',
        alipayModeF2f: '当面付（扫码支付）',
        alipayAppId: 'App ID',
        alipayAppIdHint: '支付宝应用 App ID',
        alipayPrivateKey: '应用私钥',
        alipayPrivateKeyHint: '应用私钥已配置，留空以保留当前值',
        alipayPrivateKeyPlaceholder: '请输入应用私钥',
        alipayPublicKey: '支付宝公钥',
        alipayPublicKeyHint: '支付宝公钥已配置，留空以保留当前值',
        alipayPublicKeyPlaceholder: '请输入支付宝公钥',
        alipayF2fEnabled: '启用当面付',
        alipayF2fHint: '启用支付宝当面付（扫码支付）',
        wechatTitle: '微信支付配置',
        wechatEnabled: '启用微信支付',
        wechatAppId: 'App ID',
        wechatAppIdHint: '微信支付应用 App ID',
        wechatMchId: '商户号',
        wechatMchIdHint: '微信支付商户号',
        wechatApiKey: 'API 密钥',
        wechatApiKeyHint: 'API 密钥已配置，留空以保留当前值',
        wechatApiKeyPlaceholder: '请输入 API 密钥',
        epayTitle: '易支付配置',
        epayEnabled: '启用易支付',
        epayApiUrl: 'API 地址',
        epayApiUrlHint: '易支付 API 接口地址',
        epayApiUrlPlaceholder: 'https://pay.example.com',
        epayPid: '商户 ID',
        epayPidHint: '易支付商户 ID',
        epayKey: '商户密钥',
        epayKeyHint: '商户密钥已配置，留空以保留当前值',
        epayType: '支付通道',
        epayTypeAlipay: '支付宝',
        epayTypeWechat: '微信支付',
        epayTypeBoth: '支付宝 + 微信支付',
        epayTypeHint: '选择易支付提供的支付通道类型',
        epayKeyPlaceholder: '请输入商户密钥'
      },
      smtp: {
        title: 'SMTP 设置',
