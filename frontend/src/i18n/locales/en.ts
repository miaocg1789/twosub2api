export default {
  ...
  modelSquare: {
    title: 'Model Square',
    subtitle: 'Browse pricing for mainstream AI models, data sourced from LiteLLM',
    ...
    priceUnit: 'Prices in USD / 1M tokens (click model name to copy)',
    prev: 'Prev',
    next: 'Next'
  },
  ...
  installGuide: {
    title: 'Install Guide',
    subtitle: 'Installation and configuration guides for AI coding tools — Windows / macOS / Linux',
    copyCommand: 'Copy command',
    claudeCodeDesc: 'Anthropic official CLI coding assistant',
    codexDesc: 'OpenAI official CLI coding assistant',
    geminiCliDesc: 'Google Gemini command-line tool',
    githubCopilotDesc: 'GitHub AI coding assistant (VS Code extension)',
    cursorDesc: 'AI-powered code editor',
    clineDesc: 'VS Code AI coding assistant extension',
    openCodeDesc: 'Open-source AI coding CLI tool (Go)',
    openClawDesc: 'Open-source AI coding CLI tool (Python)',
    steps: {
      installNodejs: 'Install Node.js (LTS)',
      installNodejsNote: 'Skip this step if Node.js >= 18 is already installed',
      installClaudeCode: 'Install Claude Code',
      installTool: 'Install {name}',
      configureEnv: 'Configure environment variables',
      run: 'Run',
      claudeCodeNote: 'First run will guide you through API key configuration. Replace Base URL and API Key with your actual values',
      codexNote: 'Replace Base URL and API Key with your actual values',
      geminiCliNote: "You can also run via npx {'@'}anthropic-ai/gemini-cli without global installation",
      installVscode: 'Install VS Code',
      vscodeNote: 'Skip this step if VS Code is already installed',
      vscodeAlternative: 'You can also download the .deb package from https://code.visualstudio.com',
      installExtension: 'Install {name} extension',
      configureGithubCopilot: 'Configure GitHub Copilot',
      githubCopilotNote: 'Open VS Code → Click gear icon at bottom left → Settings → Search "github.copilot" → Sign in with your GitHub account and authorize Copilot',
      downloadCursor: 'Download and install Cursor',
      cursorDownloadNote: 'You can also download from https://cursor.com',
      cursorLinuxNote: 'Download the Linux version (.AppImage) from https://cursor.com',
      installCursorLinux: 'Run the installer',
      configureCursor: 'Open Cursor and sign in',
      cursorConfigNote: 'Open Cursor → Settings → Models → Configure your API information',
      configureCursorModel: 'Configure custom API endpoint',
      cursorModelNote: 'In Cursor Settings → Models, enter your API Base URL and API Key',
      configureCline: 'Configure Cline extension',
      clineConfigNote: 'Open VS Code → Click Cline icon in sidebar → In settings, select API Provider "OpenAI Compatible", enter your Base URL and API Key',
      installGo: 'Install Go',
      goNote: 'Skip this step if Go >= 1.21 is already installed',
      installPython: 'Install Python',
      pythonNote: 'Skip this step if Python >= 3.10 is already installed',
    }
  },
  ...
  wallet: {
    title: 'Wallet',
    description: 'Top up balance, redeem codes and transaction history',
    currentBalance: 'Current Balance',
    concurrency: 'Concurrency',
    requests: 'requests',
    topUp: 'Top Up',
    ...
    amountRange: 'Amount range: {currency}{min} - {currency}{max}',
    creditPreview: 'You will receive ${credit} in credits',
    paymentMethod: 'Payment Method',
    methodAlipay: 'Alipay',
    methodAlipayF2f: 'Alipay F2F',
    methodWechat: 'WeChat Pay',
    methodEpay: 'EasyPay',
    methodEpayAlipay: 'Alipay',
    methodEpayWechat: 'WeChat Pay',
    payNow: 'Pay Now',
    creating: 'Creating order...',
    createOrderFailed: 'Failed to create order. Please try again later.',
    completePayment: 'Complete Payment',
    scanQrCode: 'Scan the QR code with your phone to complete payment',
    redirecting: 'Redirecting to payment page...',
    goToPay: 'Go to Pay',
    waitingPayment: 'Waiting for payment confirmation...',
    alreadyPaid: 'I have already paid',
    checking: 'Checking...',
    notPaidYet: 'Payment not confirmed yet, please try again later',
    checkFailed: 'Failed to check payment status',
    paymentSuccessTitle: 'Payment Successful!',
    paymentSuccessMessage: 'Your balance has been updated. Thank you for your top-up.',
    paymentExpired: 'Order expired or payment failed',
    recentActivity: 'Recent Activity',
    last30Days: 'Last 30 days',
    topUpOrder: 'Top-up',
    clickToShowOrderNo: 'Click to show full order number',
    historyEmpty: 'No transaction history yet',
    orderHistory: 'Payment Orders',
    orderNo: 'Order No',
    orderAmount: 'Amount',
    orderCredit: 'Credit',
    orderStatus: 'Status',
  ...
  referral: {
    title: 'Referral',
    description: 'Invite friends to register and earn commissions on their top-ups',
    ...
    enabledHint: 'When enabled, users can invite friends via referral links and earn commissions on their top-ups',
  ...
  admin: {
    ...
    groups: {
      ...
      rateMultiplierHint: '0 = Free, 0.5 = Half price, 1.0 = Standard, 2.0 = Double',
      ...
      perRequestPricing: {
        ...
        desc: 'When enabled, all requests in this group will be billed at a fixed price per request instead of per-token',
        price: 'Price Per Request (USD)',
        pricePlaceholder: 'e.g. 0.01',
        priceHint: 'All requests in this group will be billed at this fixed price',
        enabled: 'Enabled',
        disabled: 'Disabled'
      }
    },
    ...
    accounts: {
      ...
      upstreamModelsFetched: '{count} models fetched from upstream',
      upstreamModelsFetchError: 'Failed to fetch upstream models',
      ...
      dailyLimits: {
        title: 'Daily Limits',
        hint: 'Limit daily cost and request count per account. Auto-pauses scheduling when exceeded, resets at midnight',
        cost: {
          label: 'Daily Cost Limit',
          placeholder: '50',
          hint: 'Account pauses scheduling until midnight when exceeded. 0 or empty means no limit'
        },
        requests: {
      ...
      oauth: {
        ...
        // Qwen specific
        qwen: {
          accountTypeOAuth: 'OAuth Authorization',
          accountTypeOAuthDesc: 'Create Qwen account via OAuth authorization',
          accountTypeApiKey: 'API Key',
          accountTypeApiKeyDesc: 'Create Qwen account using API Key'
        },
        // Kiro specific
        kiro: {
          title: 'Kiro Account Authorization',
          authType: 'Authorization Type',
          refreshTokenPlaceholder: 'Paste your Kiro Refresh Token...\n\nSupports plain text format:\naoaAAAAAGmlwqQpPlyXAvj0OB4z-c1y9A33T5LTQCvAjPyZzmikPpH07YKrgB4RFUCK_Fmx61HOk6zlr8CL55Y0LkBkc0:MGQCMCO/C8+I9F8Bwj0ynHxJntnS0+fQpOtAe6ct4IzO36tJCieWnQojQkZ+i2OInFhxaAIwF4lVyeJ7kf7lUYYd5qu5ruHNL7KMRgvw6BpAiKpJp7ErCBFQm/8K+JmRZZNq4t81\n\nOr JSON format (with clientId, clientSecret, accessToken, refreshToken fields)',
          refreshTokenHint: 'Supports both Social and IdC authorization types, accepts plain text or JSON format',
          validating: 'Validating...',
          validateAndCreate: 'Validate & Create',
          pleaseEnterRefreshToken: 'Please enter Refresh Token'
        },
        ...
        kimi: {
          ...
          deviceFlowDesc: 'Complete Kimi account authorization using device code'
        },
        // iFlow specific
        iflow: {
          cookieAuth: 'Cookie Authorization',
          cookieAuthDesc: 'Complete iFlow account authorization using browser cookies'
        }
      ...
      usageWindow: {
        ...
        gemini3Image: 'GImage',
        claude: 'Claude',
        kiroQuota: '{used} / {limit} ({percent}%)',
        kiroNoQuota: 'No quota info'
      },
      tier: {
        free: 'Free',
        pro: 'Pro',
    ...
    settings: {
      ...
      payment: {
        ...
        description: 'Configure online payment for balance top-up, supporting Alipay, WeChat Pay and EasyPay',
        enabled: 'Enable Online Payment',
        enabledHint: 'Allow users to top up balance via online payment',
        generalTitle: 'General Settings',
        currency: 'Currency',
        currencyHint: 'Currency used for payments',
        exchangeRate: 'Exchange Rate',
        exchangeRateHint: 'How much platform credit per 1 unit of payment currency (e.g. 1 CNY = 0.14 USD)',
        presetAmounts: 'Preset Amounts',
        presetAmountsHint: 'Comma-separated, e.g.: 10,20,50,100',
        minAmount: 'Minimum Amount',
        minAmountHint: 'Minimum amount per top-up',
        maxAmount: 'Maximum Amount',
        maxAmountHint: 'Maximum amount per top-up',
        alipayTitle: 'Alipay Configuration',
        alipayEnabled: 'Enable Alipay',
        alipayMode: 'Alipay Mode',
        alipayModeDisabled: 'Disabled',
        alipayModeRegular: 'Regular Payment',
        alipayModeF2f: 'Face-to-Face (QR Code)',
        alipayAppId: 'App ID',
        alipayAppIdHint: 'Alipay application App ID',
        alipayPrivateKey: 'Private Key',
        alipayPrivateKeyHint: 'Private key is configured. Leave empty to keep current value.',
        alipayPrivateKeyPlaceholder: 'Enter application private key',
        alipayPublicKey: 'Alipay Public Key',
        alipayPublicKeyHint: 'Public key is configured. Leave empty to keep current value.',
        alipayPublicKeyPlaceholder: 'Enter Alipay public key',
        alipayF2fEnabled: 'Enable Face-to-Face Payment',
        alipayF2fHint: 'Enable Alipay face-to-face payment (QR code payment)',
        wechatTitle: 'WeChat Pay Configuration',
        wechatEnabled: 'Enable WeChat Pay',
        wechatAppId: 'App ID',
        wechatAppIdHint: 'WeChat Pay application App ID',
        wechatMchId: 'Merchant ID',
        wechatMchIdHint: 'WeChat Pay merchant ID',
        wechatApiKey: 'API Key',
        wechatApiKeyHint: 'API key is configured. Leave empty to keep current value.',
        wechatApiKeyPlaceholder: 'Enter API key',
        epayTitle: 'EasyPay Configuration',
        epayEnabled: 'Enable EasyPay',
        epayApiUrl: 'API URL',
        epayApiUrlHint: 'EasyPay API endpoint URL',
        epayApiUrlPlaceholder: 'https://pay.example.com',
        epayPid: 'Merchant ID',
        epayPidHint: 'EasyPay merchant ID',
        epayKey: 'Merchant Key',
        epayKeyHint: 'Merchant key is configured. Leave empty to keep current value.',
        epayType: 'Payment Channel',
        epayTypeAlipay: 'Alipay',
        epayTypeWechat: 'WeChat Pay',
        epayTypeBoth: 'Alipay + WeChat Pay',
        epayTypeHint: 'Select the payment channel type provided by EasyPay',
