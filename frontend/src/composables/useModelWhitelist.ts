...
const openaiModels = [
  ...
  // GPT-5.3 系列
  'gpt-5.3', 'gpt-5.3-2026-02-13', 'gpt-5.3-chat-latest',
  'gpt-5.3-codex', 'gpt-5.3-codex-spark', 'gpt-5.3-codex-mini',
  'gpt-5.3-pro', 'gpt-5.3-pro-2026-02-13',
  'chatgpt-4o-latest',
...
const openaiPresetMappings = [
  ...
  { label: 'GPT-5.3', from: 'gpt-5.3', to: 'gpt-5.3', color: 'bg-violet-100 text-violet-700 hover:bg-violet-200 dark:bg-violet-900/30 dark:text-violet-400' },
