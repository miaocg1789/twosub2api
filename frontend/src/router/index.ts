...
const routes: RouteRecordRaw[] = [
  ...
  // ==================== Install Guide ====================
  {
    path: '/install-guide',
    name: 'InstallGuide',
    component: () => import('@/views/user/InstallGuideView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
      title: 'Install Guide',
      titleKey: 'installGuide.title',
      descriptionKey: 'installGuide.subtitle'
    }
  },
...
router.beforeEach((to, _from, next) => {
  ...
  // 捕获推荐码
  const affCode = to.query.aff as string | undefined
  if (affCode) {
