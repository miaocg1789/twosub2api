...
- 部署指南：[deploy/DOCKER.md](deploy/DOCKER.md)
...
如果你的服务器是 **Ubuntu 24.04**，建议直接参考：[deploy/DOCKER.md](deploy/DOCKER.md)，其中包含 Docker Compose 部署的完整步骤。
