...
type GroupMutation struct {
	...
	sort_order                              *int
	addsort_order                           *int
	per_request_pricing                     *map[string]float64
	clearedFields                           map[string]struct{}
...
// SetPerRequestPricing sets the "per_request_pricing" field.
func (m *GroupMutation) SetPerRequestPricing(value map[string]float64) {
	m.per_request_pricing = &value
}

// PerRequestPricing returns the value of the "per_request_pricing" field in the mutation.
func (m *GroupMutation) PerRequestPricing() (r map[string]float64, exists bool) {
	v := m.per_request_pricing
	if v == nil {
		return
	}
	return *v, true
...
// OldPerRequestPricing returns the old "per_request_pricing" field's value of the Group entity.
// If the Group object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *GroupMutation) OldPerRequestPricing(ctx context.Context) (v map[string]float64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPerRequestPricing is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldPerRequestPricing requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldPerRequestPricing: %w", err)
	}
	return oldValue.PerRequestPricing, nil
}

// ClearPerRequestPricing clears the value of the "per_request_pricing" field.
func (m *GroupMutation) ClearPerRequestPricing() {
	m.per_request_pricing = nil
	m.clearedFields[group.FieldPerRequestPricing] = struct{}{}
}

// PerRequestPricingCleared returns if the "per_request_pricing" field was cleared in this mutation.
func (m *GroupMutation) PerRequestPricingCleared() bool {
	_, ok := m.clearedFields[group.FieldPerRequestPricing]
	return ok
}

// ResetPerRequestPricing resets all changes to the "per_request_pricing" field.
func (m *GroupMutation) ResetPerRequestPricing() {
	m.per_request_pricing = nil
	delete(m.clearedFields, group.FieldPerRequestPricing)
}
...
func (m *GroupMutation) Fields() []string {
	...
	if m.per_request_pricing != nil {
		fields = append(fields, group.FieldPerRequestPricing)
	}
	return fields
}
...
func (m *GroupMutation) Field(name string) (ent.Value, bool) {
	...
	case group.FieldSortOrder:
		return m.SortOrder()
	case group.FieldPerRequestPricing:
		return m.PerRequestPricing()
	}
	return nil, false
}
...
func (m *GroupMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case group.FieldPerRequestPricing:
		return m.OldPerRequestPricing(ctx)
	}
...
func (m *GroupMutation) ClearedFields() []string {
	...
	if m.FieldCleared(group.FieldPerRequestPricing) {
		fields = append(fields, group.FieldPerRequestPricing)
	}
	return fields
}
