...
func (_c *GroupCreate) SetPerRequestPricing(v map[string]float64) *GroupCreate {
	_c.mutation.SetPerRequestPricing(v)
	return _c
}
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.PerRequestPricing(); ok {
		_spec.SetField(group.FieldPerRequestPricing, field.TypeJSON, value)
		_node.PerRequestPricing = value
	}
