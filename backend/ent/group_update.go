...
func (_u *GroupUpdate) SetPerRequestPricing(v map[string]float64) *GroupUpdate {
	_u.mutation.SetPerRequestPricing(v)
	return _u
}

// ClearPerRequestPricing clears the value of the "per_request_pricing" field.
func (_u *GroupUpdate) ClearPerRequestPricing() *GroupUpdate {
	_u.mutation.ClearPerRequestPricing()
	return _u
}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.PerRequestPricing(); ok {
		_spec.SetField(group.FieldPerRequestPricing, field.TypeJSON, value)
	}
	if _u.mutation.PerRequestPricingCleared() {
		_spec.ClearField(group.FieldPerRequestPricing, field.TypeJSON)
	}
...
// SetPerRequestPricing sets the "per_request_pricing" field.
func (_u *GroupUpdateOne) SetPerRequestPricing(v map[string]float64) *GroupUpdateOne {
	_u.mutation.SetPerRequestPricing(v)
	return _u
}

// ClearPerRequestPricing clears the value of the "per_request_pricing" field.
func (_u *GroupUpdateOne) ClearPerRequestPricing() *GroupUpdateOne {
	_u.mutation.ClearPerRequestPricing()
	return _u
}
