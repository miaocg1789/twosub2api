...
const (
	...
	// FieldPerRequestPricing holds the string denoting the per_request_pricing field in the database.
	FieldPerRequestPricing = "per_request_pricing"
