...
func RegisterGatewayRoutes(
	...
	gateway.Use(gin.HandlerFunc(apiKeyAuth))
	{
		...
		// OpenAI-compatible chat completions (DeepSeek/Qwen/GLM/NewAPI)
		gateway.POST("/chat/completions", h.OpenAICompat.ChatCompletions)
		// Image generation
		gateway.POST("/images/generations", h.OpenAICompat.ImageGenerations)
		// Video generation (Gemini Veo)
		gateway.POST("/videos/generations", h.OpenAICompat.VideoGenerations)
		gateway.GET("/videos/operations/:operationId", h.OpenAICompat.VideoOperationStatus)
	}
