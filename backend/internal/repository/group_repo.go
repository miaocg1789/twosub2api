...
func (r *groupRepository) Create(ctx context.Context, groupIn *service.Group) error {
	...
	// 设置按次计费配置
	if groupIn.PerRequestPricing != nil {
		builder = builder.SetPerRequestPricing(groupIn.PerRequestPricing)
	}
...
func (r *groupRepository) Update(ctx context.Context, groupIn *service.Group) error {
	...
	// 处理 PerRequestPricing：nil 时清除，否则设置
	if groupIn.PerRequestPricing != nil {
		builder = builder.SetPerRequestPricing(groupIn.PerRequestPricing)
	} else {
		builder = builder.ClearPerRequestPricing()
	}
