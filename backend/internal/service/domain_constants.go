...
const (
	...
	SettingKeyFallbackModelGLM         = "fallback_model_glm"
	...
	SettingKeyPaymentCurrency      = "payment_currency"       // 支付货币（默认 CNY）
	SettingKeyPaymentExchangeRate  = "payment_exchange_rate"  // 汇率：1 CNY = X 余额
	SettingKeyPaymentPresetAmounts = "payment_preset_amounts" // 预设金额 JSON: [10,50,100,500]
	SettingKeyPaymentMinAmount     = "payment_min_amount"     // 最小充值金额
	SettingKeyPaymentMaxAmount     = "payment_max_amount"     // 最大充值金额

	// 支付宝
	SettingKeyAlipayEnabled    = "payment_alipay_enabled"
	SettingKeyAlipayAppID      = "payment_alipay_app_id"
	SettingKeyAlipayPrivateKey = "payment_alipay_private_key"
	SettingKeyAlipayPublicKey  = "payment_alipay_public_key"
	SettingKeyAlipayF2FEnabled = "payment_alipay_f2f_enabled" // 当面付

	// 微信支付
	SettingKeyWechatEnabled = "payment_wechat_enabled"
	SettingKeyWechatAppID   = "payment_wechat_app_id"
	SettingKeyWechatMchID   = "payment_wechat_mch_id"
	SettingKeyWechatAPIKey  = "payment_wechat_api_key"

	// 通用易支付
	SettingKeyEpayEnabled = "payment_epay_enabled"
	SettingKeyEpayAPIURL  = "payment_epay_api_url"
	SettingKeyEpayPID     = "payment_epay_pid"
	SettingKeyEpayKey     = "payment_epay_key"
	SettingKeyEpayType    = "payment_epay_type" // alipay, wxpay, both
